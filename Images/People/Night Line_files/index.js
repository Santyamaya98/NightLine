...
if (TitleExperiencias){
    ...
    TitleExperiencias.innerHTML = "Más que eventos creamos experiencias <br><br>";
}   
if (TextExperiencias){
    TextExperiencias.style.color = "White";
    TextExperiencias.style.display = "column";
    TextExperiencias.innerHTML = "Nos encargamos de la producción, la música y cada detalle para que tu evento fluya sin estrés y se convierta en una experiencia inolvidable. <br><br>";
}